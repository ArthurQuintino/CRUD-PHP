...
<body style="
  justify-content:center; display:flex; align-content:center; align-items:center; align-self:center; width: 100%; height: 100%; position: fixed; background-color:#010101;">
    <div class="container" style="display:flex;">
            ...
            $sql = "UPDATE `distribuição` SET  `nome` = '$nome', `dia`  = '$dia' where $codigo = `codigo`";

            if(mysqli_query($connection, $sql))
            {
                echo '<p style="color:white;">Dados Alterados com sucesso</p>';
            }else{
                echo '<p style="color:white;>Dados nao foram alterados</p>';
            }
