  ...
  ?>
    ...
    <form action="edit_delete.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nome do contribuinte" name="nome" required value="<?php echo $linha['nome']; ?>" Readonly>
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Dias Recebidos o leite:</label>
                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Dias Recebidos do Contribuinte" name="dia" required value ="<?php echo $linha['dia']?>" Readonly>
            </div>
